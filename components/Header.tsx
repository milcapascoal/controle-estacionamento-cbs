...
const Header: React.FC<HeaderProps> = ({ onOpenModal, onOpenReportModal, onOpenSettingsModal }) => {
  return (
    <header className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <h1 className="text-xl lg:text-2xl font-bold text-slate-700">Controle de Estacionamento</h1>
